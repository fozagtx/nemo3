    ...
    if (data.isGenerating) {
      return (
        <div className="space-y-3 sm:space-y-4">
          ...
          {data.scriptText && (
            <div className="p-2 sm:p-3 bg-card rounded-lg border border-border">
        ...
        <div className="bg-background rounded-lg p-3 sm:p-4 border border-border">
          <div className="flex items-center space-x-2 sm:space-x-3 mb-3">
            <Button
              ...
              size="sm"
              className="bg-primary hover:bg-primary/90 text-primary-foreground w-9 h-9 sm:w-10 sm:h-10 rounded-full p-0"
            >
              {isPlaying ? (
